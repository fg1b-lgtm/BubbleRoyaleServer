...
| 9/1 | 맵 조각 10종 · 화면·소리 재설계 | 판이 "어디인지" 알아볼 수 있다 | ✅ |
...
어떤 파일을 어디에 쓰는지는 `web/audio.js` 맨 위 `CLIPS` 표 한곳에 모여 있다.
...
|---|---|
| 출처 | **OpenAI ChatGPT (이미지 생성)** 로 만들었다 |
| 무엇 | 마을·사막 바닥, 나무·돌·집·우물 같은 조형물, 상자, 사막 조형물 세트(desert17) |
