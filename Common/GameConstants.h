...
//   128  옆이 뚫려 있으면 언제나 붙는다
//
// 9/1 에 90 에서 128 로 올렸다. 몸이 벽을 못 넘게 바꾼 것과 한 세트다.
//
// 통로 안에서 몸(204)이 칸(256)에 갇히면 중심이 102~154 사이에만 있을 수 있다.
// 그 범위는 90 에도 166 에도 안 닿아서 **보정이 아예 안 걸리게 된다.**
// 벽에 안 파묻히게 만들었더니 코너를 못 돌게 된 것이다.
//
// 128 이면 옆이 뚫려 있을 때는 언제나 걸린다. 그래도 안 미끄럽다.
// 한 틱에 speed(18) 만큼만 밀어서 코너 하나 도는 데 0.2초쯤 걸리기 때문이다.
// 방향을 놓으면 그 자리에 선다
constexpr int CORNER_ASSIST = 128;
